...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "AuraXBot")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/kaal0408/LuciferXBot"
        )
        ...
        EXTRA_AuraXBot = os.environ.get("EXTRA_LuciferXBot", -1001221881562)
